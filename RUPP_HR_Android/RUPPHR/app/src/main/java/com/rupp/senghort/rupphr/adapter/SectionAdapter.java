...
public class SectionAdapter extends RecyclerView.Adapter<SectionAdapter.SectionViewHolder> {
    ...
    private ArrayList<Section> sectionModelArrayList;

    public SectionAdapter(Context context, RecyclerViewType recyclerViewType, ArrayList<Section> sectionModelArrayList) {
    ...
    public SectionViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.section_row_layout, parent, false);
        return new SectionViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SectionViewHolder holder, int position) {
        final Section sectionModel = sectionModelArrayList.get(position);
        ...
        ItemAdapter adapter = new ItemAdapter(context, sectionModel.getItemArrayList());
